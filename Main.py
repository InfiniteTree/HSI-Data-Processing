...
class Main(QMainWindow, Ui_MainWindow):
    ...
    def getRgb(self, function):
        match function:
            ...
            case "Save":
                if self.rawSpeFile_path != "":
                    self.rgbImg.save("figures/test/" + self.impFileNum + ".jpg")
    ...
    def RmBg(self, function):
        match function:
            case "Gene":
                level1 = RemoveBG.getLevel1(self.HSI_info, self.NDVI_TH)
            ...
            case "View":
                ...
                l1_rgbImg.show()
            case "Save":
                l1_rgbImg.save("figures/test/pre_process/"+ self.impFileNum +"_level1.jpg")
